 ...
 * Three types of enchantments are available:
 1. Durability: Increases the integrity and max integrity of the weapon by 100. * The enchantment will lasts for 15 minutes, and will automatically refresh in the hand of an Arcyne user.
